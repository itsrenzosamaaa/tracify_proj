...
const ViewItemPage = ({ params }) => {
  ...
  const fetchLostItem = useCallback(async (foundItemId) => {
    ...
    try {
      ...
      const findLostItem = data.find(
        (lostItem) =>
          lostItem?.finder?.item?._id === foundItemId &&
          ["Pending", "Approved"].includes(lostItem.request_status)
      );
              ...
              <Grid item xs={12}>
                ...
                >
                  ...
                  >
                    ...
                    <Button
                      onClick={() => router.push("/my-items#found-item")}
                      color="danger"
                    ...
                    <Grid item xs={12} md={4}>
                      <Box>
                        ...
                        <Typography
                          ...
                          sx={{ mb: 2 }}
                        >
                          Please surrender the item to <strong>SASO</strong>{" "}
                          located at the{" "}
                          <strong>1st Floor of FJN Building</strong>. For more
                          information, you may contact <strong>SASO</strong> at:
                        </Typography>
                        ...
                        >
                          ...
                          >
                            ...
                            <Typography
                              ...
                              sx={{ color: "text.secondary" }}
                            >
                              Reach out to the officer in charge for further
                              assistance.
                            </Typography>
                          </Box>
                        </Step>
                        ...
                        >
                          ...
                          >
                            ...
                            <Typography
                              ...
                              sx={{ color: "text.secondary" }}
                            >
                              Confirm the item has been surrendered to complete
                              the process.
                            </Typography>
                          </Box>
                        </Step>
                  ...
                  <Stepper orientation="vertical">
                    ...
                    {foundItem.dateValidating && (
                      <Step>
                        <Typography level={isXs ? "body-sm" : "body-md"}>
                          <strong>
                            Your item has been approved! Please surrender the
                            item to SASO.
                          </strong>
                        </Typography>
                        <Typography level={isXs ? "body-sm" : "body-md"}>
              ...
              {lostItem ? (
                <Stack spacing={2}>
                  ...
                  >
                    ...
                    {lostItem.owner.item.description}
                  </Typography>
                  <Box
                    sx={{
                      display: "flex",
                  ...
                  >
                    ...
                    <Box>
                      ...
                      >
                        <strong>Distinctive Marks:</strong>{" "}
                        {lostItem.owner.item.distinctiveMarks}
                      </Typography>
                    </Box>
                  </Box>
                  <Divider />
                  <Box>
                    ...
                    >
                      ...
                      {lostItem.owner.item.date_time?.split(" to ")[0] ||
                        "Unidentified"}
                    </Typography>
                    <Typography
                      level={isXs ? "body-sm" : "body-md"}
                    ...
                    >
                      ...
                      {lostItem.owner.item.date_time?.split(" to ")[1] ||
                        "Unidentified"}
                    </Typography>
                  </Box>
                </Stack>
                ...
                >
                  ...
                  <Typography color="text.secondary" sx={{ fontSize: "1rem" }}>
                    We&apos;re still looking for a match. Please check back
                    later!
                  </Typography>
                </Box>
              )}
