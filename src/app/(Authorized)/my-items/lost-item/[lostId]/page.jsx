                                ...
                                <Stack spacing={3}>
                                    <Box>
                                        ...
                                        <Typography level="body2" color="text.secondary" textAlign="justify">
                                            Please come to <strong>{foundItem.finder?.item?.monitoredBy?.role.name}</strong>, located at 
                                            <strong> {foundItem.finder?.item?.monitoredBy?.office_location}</strong> during office hours. 
                                            You may also contact <strong>{foundItem.finder?.item?.monitoredBy?.role.name}</strong> at 
                                            <strong> {foundItem.finder?.item?.monitoredBy?.contactNumber}</strong> or 
                                            <strong> {foundItem.finder?.item?.monitoredBy?.emailAddress}</strong>.
                                        </Typography>
                                    </Box>
                                    ...
                                    <Box>
                                        ...
                                        <Typography level="body2" color="text.secondary" sx={{ mb: 1 }}>
                                            <strong>Found Item Name:</strong> {foundItem?.finder?.item?.name}
                                        </Typography>
                                        <Typography level="body2" color="text.secondary" sx={{ mb: 1 }}>
                                            <strong>Description:</strong> {foundItem?.finder?.item?.description}
                                        </Typography>
                                        <Typography level="body2" color="text.secondary" sx={{ mb: 1 }}>
                                            <strong>Date Found:</strong> {new Date(foundItem?.finder?.item?.date).toLocaleDateString()}
                                        </Typography>
