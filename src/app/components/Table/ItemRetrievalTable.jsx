                    ...
                    <CardActions>
                      {row.request_status === "Pending" && (
                        <>
                          <Button
                            size="small"
                            onClick={() => setOpenClaimRequestModal(row._id)}
                          >
                            View Details
                          </Button>
                          <ItemClaimRequestModal
                            row={row}
                            open={openClaimRequestModal}
                            onClose={() => setOpenClaimRequestModal(null)}
                      ...
                      {row.request_status === "Approved" && (
                        <>
                          <Button
                            size="small"
                            onClick={() => setOpenReservedModal(row._id)}
                          >
                            View Details
                          </Button>
                          <ItemReservedModal
                            row={row}
                            open={openReservedModal}
                            onClose={() => setOpenReservedModal(null)}
                            refreshData={fetchItems}
                            setMessage={setMessage}
                            setOpenSnackbar={setOpenSnackbar}
                          />
                      ...
                      {(row.request_status === "Completed" ||
                        ...
                        <>
                          <Button
                            size="small"
                            onClick={() => setOpenCompletedModal(row._id)}
                          >
                            View Details
                          </Button>
                          <CompletedModal
                            ...
                            onClose={() => setOpenCompletedModal(null)}
                          />
                        </>
                      )}
                    </CardActions>
                      ...
                      <TableRow key={row._id}>
                        ...
                        <TableCell sx={{ width: { xs: "140px", md: "150px" } }}>
                          {(() => {
                            ...
                            const status = row?.request_status === "Completed" ? "Claimed" : "For Claiming";
                            const chipColor =
                              status === "Claimed" ? "success" : "danger";
                          ...
                          {row.request_status === "Pending" && (
                            <>
                              <Button
                                size="small"
                                onClick={() =>
                                  setOpenClaimRequestModal(row._id)
                                }
