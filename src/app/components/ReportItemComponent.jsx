...
const ReportItemComponent = ({ isFoundItem, session }) => {
  ...
  const steps = [
    {
      ...
      description: "Provide essential details about the item.",
    },
    {
      label: "Upload Image",
      description: "Attach an image to help identify the item.",
    },
    {
  ...
  const handleSubmit = async (e) => {
    ...
    const formData = {
      ...
      date_time: isFoundItem
        ? format(new Date(foundDate), "MMMM dd,yyyy hh:mm a")
        : itemWhereabouts
        ? `${format(
            new Date(lostDateStart),
            "MMMM dd, yyyy hh:mm a"
          )} to ${format(new Date(lostDateEnd), "MMMM dd, yyyy hh:mm a")}`
        : "Unidentified",
      images,
      status: "Request",
    ...
    if (activeStep === 0) {
      ...
      if (isFoundItem) {
        ...
        if (
          ...
          isBefore(selectedDate, thirtyDaysAgo)
        ) {
          return true;
        }
      }
    ...
    <>
      ...
      >
        <Grid item xs={12} lg={12}>
          <Paper
            elevation={2}
            sx={{ padding: "1rem", marginBottom: "20px", maxWidth: "100%" }}
          >
                      ...
                      <Grid container spacing={2}>
                        ...
                        <Grid item xs={12}>
                          <FormControl fullWidth>
                            ...
                            />
                            <FormHelperText>
                              Please use your words properly to optimize
                              matching items.
                            </FormHelperText>
                          </FormControl>
                        </Grid>
                            ...
                            <Grid item xs={12} lg={6}>
                              ...
                              >
                                ...
                                <Typography
                                  sx={{ color: "#333", fontWeight: 500 }}
                                >
                                  {lostDateStart === "Unidentified"
                                    ? lostDateStart
                                    : dayjs(lostDateStart).format(
                                        "MMMM D, YYYY - hh:mm a"
                                      )}
                                </Typography>
                              </Box>
                            ...
                            <Grid item xs={12} lg={6}>
                              ...
                              >
                                ...
                                <Typography
                                  sx={{ color: "#333", fontWeight: 500 }}
                                >
                                  {lostDateEnd === "Unidentified"
                                    ? lostDateEnd
                                    : dayjs(lostDateEnd).format(
                                        "MMMM D, YYYY - hh:mm a"
                                      )}
                                </Typography>
                              </Box>
            ...
            <Modal open={showSuccessModal}>
              <ModalDialog>
                ...
                <Typography level="body1">
                  Item has been reported successfully. Redirecting in{" "}
                  {countdown} seconds...
                </Typography>
                <Button
                  onClick={() => router.push("/my-items#requested-item")}
                  sx={{ mt: 2 }}
                >
                  Redirect now
                </Button>
