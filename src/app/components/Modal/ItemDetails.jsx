                ...
                >
                    ...
                    <TabPanel value="1" sx={{ padding: { xs: 1, lg: 2 } }}>
                        <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                            <tbody>
                                <tr>
                                    <td style={{ borderBottom: '1px solid black', borderRight: '1px solid black', padding: '8px', fontWeight: 'bold' }}>
                                ...
                                <tr>
                                    <td style={{ borderBottom: '1px solid black', borderRight: '1px solid black', padding: '8px', fontWeight: 'bold' }}>
                                        <Tooltip title="Item Located" arrow>
                                            <LocationOnIcon />
                                        </Tooltip>
                                    </td>
                                ...
                                <tr>
                                    <td style={{ borderBottom: '1px solid black', borderRight: '1px solid black', padding: '8px', fontWeight: 'bold' }}>
                                        <Tooltip title="Date Found" arrow>
                                            <CalendarTodayIcon />
                                        </Tooltip>
                                    </td>
                                ...
                                <tr>
                                    <td style={{ borderRight: '1px solid black', padding: '8px', fontWeight: 'bold' }}>
                                        <Tooltip title="Time Found" arrow>
                                            <AccessTimeIcon />
                                        </Tooltip>
                                    </td>
