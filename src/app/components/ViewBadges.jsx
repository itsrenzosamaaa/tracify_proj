        ...
        <Grid item xs={12}>
                    ...
                    .map((badge) => (
                      <TableRow key={badge._id}>
                        ...
                        <TableCell>
                          <IconButton
                            onClick={(event) =>
                              handleMenuOpen(event, badge._id)
                            }
                            aria-controls={
                              currentBadgeId === badge._id
                                ? `menu-${badge._id}`
                                : undefined
                            }
                            aria-haspopup="true"
                            aria-expanded={
                              currentBadgeId === badge._id ? "true" : undefined
                            }
                          >
                            <MoreHoriz />
                          </IconButton>
          ...
          >
            <ModalDialog>
              ...
              {/* Red warning text */}
              <Typography level="body2" fontWeight="400" color="danger" sx={{ wordBreak: true }}>
                Warning: This action will permanently remove the badge from the
                students&apos; owned badges.
              </Typography>
