...
import { Grid, Stepper, Stack, Step, Typography, Button, StepIndicator, Box, FormControl, FormLabel, Input, Textarea, FormHelperText } from '@mui/joy';
                        ...
                        <Paper elevation={2} sx={{ padding: '1rem', marginBottom: '20px', maxWidth: '100%' }}>
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                <Stack direction="row" justifyContent="space-between" sx={{ marginTop: '20px' }}>
                                    ...
                                    <Button disabled={isNextDisabled()} onClick={activeStep === 3 ? handleSubmit : handleNext}>
